...
var (
	gt15true1 = sexa.NewAngle(false, 0, 0, 58.294).Rad()
	gt15true2 = sexa.NewAngle(false, 0, 0, 0.0668).Rad()
	gt15app1  = sexa.NewAngle(false, 0, 0, 58.276).Rad()
	gt15app2  = sexa.NewAngle(false, 0, 0, 0.0824).Rad()
)
