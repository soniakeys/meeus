...
func MeanObliquity(jde float64) float64 {
	return hints.Horner(c2000(jde), []float64{
...
func MeanObliquityLaskar(jde float64) float64 {
	return hints.Horner(c2000(jde)*.01, []float64{
		common.NewAngle(false, 23, 26, 21.448).Rad(),
